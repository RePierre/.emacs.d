...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "tex" '("TeX-" "Bib" "docTeX-default-extension" "LaTeX-" "plain-TeX-auto-regexp-list" "VirTeX-common-initialization" "tex-" "ConTeXt-")))
